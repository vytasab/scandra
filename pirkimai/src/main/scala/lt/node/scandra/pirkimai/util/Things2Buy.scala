 ...
 */
class Things2Buy {
  import Things2Buy._  // companion object
  
  def getOrderXml: String = {"""<orderxml datetime="2012-01-26 22:46">
    <t  n="pienas" m="1 ltr" f="2.5%" />
    <t  n="jogurtas" m="1 ltr" r="Vaisinis" />
    <t  n="bulvės" m="1 kg" q="1" r="_" />
</orderxml>"""}
...
object Things2Buy {
  ...
  case class Thing(status: String, thing: String)
  // status: 2 - nenupirkta, 1 - dalinai nupirkta, 0 - nupirkta

  private final val sInstance = new Things2Buy()

  def getInstance: Things2Buy = sInstance
